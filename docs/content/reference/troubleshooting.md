...
Most of these come down to network reality or how alternativeme serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

alternativeme rate-limits like any public site. alternativeme already paces
...
Where a surface is gated, alternativeme reads a cookie or token you supply
...
`alternativeme`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what alternativeme actually did
