...
```
alternativeme <command> [arguments] [flags]
```

Run `alternativeme <command> --help` for the full flag list on any command. This
...
per operation you declare in `alternativeme/domain.go`.
